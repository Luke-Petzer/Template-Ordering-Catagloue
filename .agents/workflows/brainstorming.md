...
8. **Transition to implementation** — invoke `/writing-plans` workflow to create implementation plan
...
- Invoke the `/writing-plans` workflow to create a detailed implementation plan
- Do NOT invoke any other workflow. `/writing-plans` is the next step.
